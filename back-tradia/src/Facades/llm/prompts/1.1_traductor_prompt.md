...
- For other minor decorative images that are not important (e.g. simple lines or generic icons), you may omit them.
...
- Example response: `<page><style>p { color: black; }</style><div><p>text translated</p></div><div class="maria-signature" data-x="0.75" data-y="0.82" data-width="0.15" data-height="0.08"></div></page>`
